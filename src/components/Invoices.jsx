            ...
            <div>
                ...
                <div className='p-4'>
                    <div className=' bg-gradient-to-r from-blue-700 to-blue-400 p-3 rounded-lg mb-1 w-28'>
                        <i class="fa-solid fa-file-invoice-dollar text-xl text-white"></i>
                        <h1 className='text-white text-base font-bold cursor-pointer'>Invoices</h1>
                    </div>
                </div>
                <div>
            ...
            <p>Created At: {selectedCustomer.contact_form_created_at}</p> */}
                            <div id={id} ref={nodeRef} className='my-10'>
                                <div className='bg-gradient-to-r from-blue-700 to-blue-400 rounded-t-md p-4'>
                                    ...
                                    <h1 className='text-sm xl:text-xl text-white'>Invoice Information #{selectedCustomer.contact_form_id}</h1>
                                </div>
                                <div className='bg-white p-4 rounded-b-md py-10'>
                                    <div className='flex gap-1 justify-between'>
                                        <div className='bg-rose-500 text-white p-2 rounded-lg cursor-pointer hover:scale-105 tooltip tooltip-error' data-tip="Customer has not paid">
                                            <h1> Status: Unpaid <i class="fa-solid fa-circle-exclamation"></i></h1>
                                        </div>
