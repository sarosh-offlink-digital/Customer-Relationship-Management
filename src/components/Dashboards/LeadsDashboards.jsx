            ...
            <div className="flex w-full">
                <div className="flex-1 p-4">
                    ...
                    <div className='flex flex-wrap justify-between items-center my-3'>
                        <div className=' bg-gradient-to-r from-blue-700 to-blue-400 p-2 rounded-lg mb-1 '>
                            {/* <img src={dashboardlogo} alt="db" /> */}
                            <i className="fa-solid fa-chalkboard-user text-white text-lg "></i>
                            <h1 className='text-white text-base font-bold cursor-pointer'>Leads Dashboard</h1>
                        </div>
                        <DateTimeDisplay />
                    </div>
                    ...
                    <div className='flex gap-4 justify-center flex-wrap'>
                        <div className='lg:w-[48%] mt-6 '>
                            <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-cyan-500 font-semibold'>Leads and Customers</h1>
                                </div>
                        ...
                        <div className='lg:w-[48%] mt-6 '>
                            <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-blue-800 font-semibold'>Leads and Customers Conversion</h1>
                                </div>
                        ...
                        <div className='lg:w-[48%] mt-6 '>
                            <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-yellow-500 font-semibold'>Most Ordered Packages</h1>
                                </div>
                        ...
                        <div className='lg:w-[48%] mt-6 '>
                            <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-orange-600 font-semibold'>Leads Coming from</h1>
                                </div>
                                <BarChartDBBrands leadsDataDB={leadsDataDB} customerDataDB={customerDataDB} />
                            </div>
                        </div>
                        <div className='lg:w-[48%]  '>
                            {/* <div className=' border-2 bg-gray-100 rounded-lg shadow-lg py-3' >
                                <div className='text-center mb-5'>
                                    <h1 className='text-cyan-500 font-semibold'>Projects By Stage </h1>
                                </div>
                        ...
                        <div className='lg:w-[48%]  '>
                            {/* <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-purple-800 font-semibold'>Customer Payment Status </h1>
                                </div>
                                <div className='flex justify-center'>
                                    <PieChartDB />
                                </div>
                        ...
                        <div className='lg:w-[48%]  '>
                            {/* <div className='border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-pink-700 font-semibold'>Projects By Status</h1>
                                </div>
                        ...
                        <div className='lg:w-[48%]  '>
                            {/* <div className=' border-2 bg-gray-100 rounded-lg shadow-lg py-3'>
                                <div className='text-center mb-5'>
                                    <h1 className='text-cyan-500 font-semibold'>Customers By Status </h1>
                                </div>
                                <FunnelChartApex />
                            </div> */}
                        </div>
