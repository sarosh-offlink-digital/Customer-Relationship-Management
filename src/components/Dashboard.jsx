                ...
                <div className="flex-1 p-4">
                    ...
                    {/* <div className='flex flex-wrap justify-between items-center my-3'>
                        <div className=' bg-gradient-to-r from-blue-700 to-blue-400 p-3 rounded-lg mb-1 '>
                            ...
                            <h1 className='text-white text-base font-bold cursor-pointer'>Main Dashboard</h1>
                        </div>
                        <DateTimeDisplay />
                    </div> */}
                    ...
                    <div className='flex gap-2 mt-2  flex-wrap lg:gap-3 justify-start text-center items-center'>
                        ...
                        <div className=' border-2 shadow-lg border-red-500 border-l-[12px] flex  flex-wrap justify-between lg:justify-between gap-1 lg:gap-2 items-center text-center   cursor-pointer lg:h-16 h-16 w-full lg:w-auto  text-red-500  px-2 rounded-md py-4'>
                    ...
                    <div className='flex gap-4 justify-center lg:justify-start flex-wrap'>
                        <div className=' border-2 border-slate-700 px-2 rounded-lg lg:w-[32%]  mt-6 '>
                        ...
                        <div className=' border-2 border-slate-700 px-2 rounded-lg lg:w-[32%]  mt-6 '>
                            <div className=' bg-slate-900 rounded-lg shadow-lg py-3'>
                                <div className='text-lg px-3 mb-5'>
                                    <h1 className='text-white font-semibold'>Task Stages</h1>
                                </div>
                                {/* <BarChartDB leadsDataDB={leadsDataDB} customerDataDB={customerDataDB} /> */}
                                <MultiGroupDB />
                            </div>
